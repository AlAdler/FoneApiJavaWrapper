...
public class Utils {
	...
	public static String addCustomParamsToUrl(String url, CustomParameter... customParams){
		String retVal = url;
        if (retVal != null && customParams.length > 0)
        {
            ...
            for (int i = 0; i < customParams.length; i++)
            {
                ...
                builder.append(customParams[i].getKey()).append(EQUALS_SIGN).append(customParams[i].getValue());
            }
